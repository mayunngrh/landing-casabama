...
const RAW_VILLAS: RawVillaDetail[] = [
  {
    ...
    galleryImages: Array.from({ length: 27 }, (_, i) => `/images/accommodation/panggung/gallery-${i + 1}.jpg`),
    sizeSqM: 399,
    bedroomCount: 3,
  ...
  },
  {
    ...
    galleryImages: Array.from({ length: 35 }, (_, i) => `/images/accommodation/sandiwara/gallery-${i + 1}.jpg`),
    sizeSqM: 911,
    bedroomCount: 4,
  ...
  },
  {
    ...
    galleryImages: Array.from({ length: 41 }, (_, i) => `/images/accommodation/panjang/gallery-${i + 1}.jpg`),
    sizeSqM: 906,
    bedroomCount: 4,

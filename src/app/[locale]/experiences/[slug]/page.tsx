...
export default function ExperienceDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="bg-white text-stone-700 min-h-screen">
      ...
      {/* Back button */}
      <div className="px-8 md:px-24 pt-16 pb-8">
        <Animate>
          <button
            onClick={() => router.push("/experiences")}
            className="text-[10px] tracking-[0.25em] text-stone-400 hover:text-stone-700 transition-colors uppercase flex items-center gap-2"
          >
            ← Back to Experiences
          </button>
        </Animate>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        {/* Content */}
        <Animate delay={100} className="flex flex-col justify-center px-8 md:px-16 py-12 md:py-0">
